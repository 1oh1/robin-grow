...
// @updateURL    https://github.com/1oh1/robin-settle/raw/master/robin.user.js
...
(function() {
    ...
    // Options begin
    addBoolSetting("removeSpam", "Remove bot spam", false);
    addBoolSetting("findAndHideSpam", "Removes messages that have been send more than 3 times", false);
    ...
    if (!settings["vote"]) {
		if ($(".robin-message--message:contains('Voting will end in approximately 31 minutes')").length > 0) {
			setVote("stay");
		}
		else {
			settings["vote"] = "grow";
